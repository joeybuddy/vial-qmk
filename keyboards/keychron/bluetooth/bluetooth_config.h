...
// Aliases for indicator.c compatibility
#ifndef DISCONNECTED_BACKLIGHT_DISABLE_TIMEOUT
#    define DISCONNECTED_BACKLIGHT_DISABLE_TIMEOUT  DISCONNECTED_BACKLIGHT_OFF_DELAY_TIME
#endif

#ifndef CONNECTED_BACKLIGHT_DISABLE_TIMEOUT
#    define CONNECTED_BACKLIGHT_DISABLE_TIMEOUT     CONNECTED_BACKLIGHT_OFF_DELAY_TIME
#endif
